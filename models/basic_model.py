...
def optim_func_loss_l2(theta, input_trajectories, initial_conditions, scale, gps: list[HSGPExpQuadWithDerivative]):
    ...
    print(f"Manifold L2 loss: {average_manifold_distance}", f"parameter loss: {beta_loss.sum()}")
...
def optim_func_loss_l2_full(theta, input_trajectories, initial_conditions, scale, gps: list[HSGPExpQuadWithDerivative]):
    ...
    print(f"Manifold L2 Full loss: {average_manifold_distance}", f"parameter loss: {beta_loss.sum()}")
    return average_manifold_distance  + beta_loss.sum()


def optim_func_loss_hausdorff(theta, input_trajectories, initial_conditions, scale, gps: list[HSGPExpQuadWithDerivative]):
    ...
    print(f"Manifold Hausdorff loss: {average_manifold_distance}", f"parameter loss: {beta_loss.sum()}")
    return average_manifold_distance  + beta_loss.sum()
