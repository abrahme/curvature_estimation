...
# Motivation
1. [Vid 1](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExajNkbWVxZ2JqMjA4cWdja2w2dTVqcGtpN3h6cXhxYXpqZWZzdzAzeSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/vaXmIRpTTbjnG/giphy.gif)
2. [Vid 2](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExejMxYm5iaXR0ZTN5NzFzZm9rbTJ6NjYyb2tyZGs3ZWg5YTZsZ2oxYiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/M1iqgvQDCdX2/giphy.gif) 
...
# Geodesic Equation (Methods)
1. Christoffel Symbols
    a. $\Gamma^i_{jk} = \frac{1}{2}g^{il}[\partial_j g_{kl} + \partial_k g_{jl} - \partial_l g_{jk}]$
2. Geodesic Equation in 2D
    a. $\Ddot{x} + \Gamma^x_{xx}\dot{x}^2 + 2\Gamma^x_{xy}\dot{x}\dot{y} + \Gamma^{x}_{yy}\dot{y}^2 = 0$
    b. $\Ddot{y} + \Gamma^y_{xx}\dot{x}^2 + 2\Gamma^y_{xy}\dot{x}\dot{y} + \Gamma^{y}_{yy}\dot{y}^2 = 0$
